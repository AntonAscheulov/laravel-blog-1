                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="artist_name" type="text" class="form-control" id="exampleInputEmail1" placeholder=""
                                       value="{{$artist->artist_name}}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Профессия</label>
                                <input name="artist_profession" type="text" class="form-control" id="exampleInputEmail1" placeholder=""
                                       value="{{$artist->artist_profession}}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Аватар</label>
                                <br>
                                <img src="{{asset("storage/". $artist->artist_avatar)}}" alt="" class="img-responsive" width="200">
                                <br>
